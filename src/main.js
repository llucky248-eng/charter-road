...
(() => {
  ...
  const NPC_DIAG_BUILD = 'v0.4.24'; // single version - updated by ops/scripts/bump_version.mjs
...
function handleGlobalHudTap(clientX, clientY, e) {
  ...
  function makeMap() {
    ...
    // Ashport: medium fishing port (SE) — shifted 4 tiles west for better map centering
    const cityB = { id:'ashport',    name:'Ashport',    x: 92, y: 55, w: 24, h: 16 };
